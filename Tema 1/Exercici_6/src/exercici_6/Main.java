...
private static String ficheroAleatorioempleado = "AleatorioEmple.dat";
    ...
    public static void main(String[] args) throws IOException, ParserConfigurationException {      
        ...
        while(true){
            ...
            System.out.println("9: Guardar ficheroJSON empleados");
            System.out.println("10: Cargar ficheroJSON empleados");
            int opt= sc.nextInt();
            ...
            switch(opt)
            {
                ...
                {
                    try {
                        new FileFunctionsEmpleados().serializarEmpleado2FicheroJSON(empleados);
                ...
                {
                    try {
                        empleados = new FileFunctionsEmpleados().serializarFicheroJSON2Empleado(empleados);
                    } catch (JSONException ex) {
                        Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
